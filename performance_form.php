...
font-size: 16px;"> Last access : 05 September 2018 &nbsp; <a href="index.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Player's Performance in Matches</h2>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <form action="performance_form_submit.php" method="POST" onsubmit="return confirm('Match performances recorded successfully..!!');">
                                            <div class="col-md-12 form-group">
                                                <fieldset disabled="disabled">
                                                    <div class="col-md-4 form-group">
                                                        <label for="disabledSelect">Match Id</label>
                                                        <input class="form-control" id="disabledInput" type="text" placeholder="Keep it empty..!!" disabled />
                                                    </div>
                                                </fieldset>
                                                <div class="col-md-4 form-group">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <br /><input name="date_of_match" type="date" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!--Payment Schedule-->
                                            <div class="col-md-12 form-group">
                                                <label><br />Performances: </label></div>
                                            <div class="col-md-12 form-group">
                                                <table style="width:100%">

                                                    <tr>
                                                        <td><input name="player1" class="form-control" placeholder="Player 1" /></td>
                                                        <td><input name="player2" class="form-control" placeholder="Player 2" /></td>
                                                        <td><input name="player3" class="form-control" placeholder="Player 3" /></td>
                                                        <td><input name="player4" class="form-control" placeholder="Player 4" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input name="player5" class="form-control" placeholder="Player 5" /></td>
                                                        <td><input name="player6" class="form-control" placeholder="Player 6" /></td>
                                                        <td><input name="player7" class="form-control" placeholder="Player 7" /></td>
                                                        <td><input name="player8" class="form-control" placeholder="Player 8" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input name="player9" class="form-control" placeholder="Player 9" /></td>
                                                        <td><input name="player10" class="form-control" placeholder="Player 10" /></td>
                                                        <td><input name="player11" class="form-control" placeholder="Player 11" /></td>
                                                        <td><input name="player12" class="form-control" placeholder="Player 12" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input name="player13" class="form-control" placeholder="Player 13" /></td>
                                                        <td><input name="player14" class="form-control" placeholder="Player 14" /></td>
                                                        <td><input name="player15" class="form-control" placeholder="Player 15" /></td>
                                                        <td><input name="player16" class="form-control" placeholder="Player 16" /></td>
                                                    </tr>
                                                </table>
                                            </div>

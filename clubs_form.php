                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <form action="clubs_form_submit.php" method="POST" onsubmit="return confirm('Player is added to the club..!!');">
                                            ...
                                            <div class="col-md-12 form-group">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input name="ce_date" type="date" class="form-control" />
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <label>Start date: </label>
                                                    <input name="st_date" type="date" class="form-control" />
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <label>End date: </label>
                                                    <input name="en_date" type="date" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-12 form-group">
                                                <label><br />Address: </label></div>
                                            <div class="col-md-12 form-group">
                                                <div class="col-md-4 form-group">
                                                    <label>House No.</label>
                                                    <input name="house_no" class="form-control" />
                                                </div>
                                                <div class="col-md-4 form-group">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    <label>Name of the President</label>
